...
-   **SWH_DM.DM_FL_MS** - Table containing the market segment allocated to each flight **as of 1/1/2019**. Use the flight ID field ('FLT_UID') and 'LOBT' field (partition key) to link to other flight tables and the field 'SK_FLT_TYPE_RULE_ID' to link to the table SWH_FCT.DIM_FLIGHT_TYPE_RULE to retrieve the name of the market segment.
